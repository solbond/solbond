...
const MinimalTiptapEditor = forwardRef<HTMLDivElement, MinimalTiptapProps>(
  (
    ...
    return (
      <div
        className={cn(
          "border-input flex h-auto min-h-72 w-full flex-col rounded-md border shadow-xs dark:border-gray-800 focus-within:border-zinc-400",
          className,
        )}
        {...props}
        ref={ref}
...
const Toolbar = ({ editor }: { editor: TiptapEditor }) => {
  return (
    <div className="border-border border-b p-2 dark:border-zinc-500">

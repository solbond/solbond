...
export default () => [
  ...
  alter.model('user').create.field({ slug: 'jwtAccessToken', type: 'string' }),
  ...
  alter.model('product').create.field({ slug: 'priceInUsd', type: 'number' }),
  alter.model('product').create.field({ slug: 'published', type: 'boolean' }),
  alter.model('product').create.field({ slug: 'approved', type: 'boolean' }),
  alter.model('product').create.field({ slug: 'featured', type: 'boolean' }),
  alter
    .model('product')
    .create.field({
      slug: 'createdBy',
